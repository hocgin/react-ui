...
export default {
  ...
  HeartFilled: ({className}: any) => (<i className={classnames(className)}>
    <svg
      width="16px"
      height="16px"
      role="img"
  ...
  TplFilled: ({className}: any) => (<i className={classnames(className)}>
    {/*..*/}
  </i>),
  LikeFilled: ({className}: any) => (<i className={classnames(className)}>
    <svg
