...
export default {
  ...
  HeartFilled: ({ className }) => (<i className={classnames(className)}>
    <svg
      width='16px'
      height='16px'
      role='img'
  ...
  LikeFilled: ({ className }) => (<i className={classnames(className)}>
    <svg
  ...
  TplFilled: ({ className }) => (<i className={classnames(className)}>
    {/*..*/}
  </i>),
} as {
